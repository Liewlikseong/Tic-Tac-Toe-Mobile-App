...
public class Logic {
    ...
    public boolean updateGameBoard(int row, int col){
        if (gameBoard[row-1][col-1] == 0){
            ...
            if(player == 1){
                playerTurn.setText(playerName[1] + ": IT'S MY TURN NOW!");
            }
            else{
                playerTurn.setText(playerName[0] + ": IT'S MY TURN NOW!");
            }
            return true;
        }
        else{
        ...
        for (int r=0; r<3; r++) {
            ...
            for (int c = 0; c < 3; c++) {
                ...
                if (isWinner) {
                    ...
                    playerTurn.setText((playerName[player - 1] + ":Nah I'D WIN!!!!!!!"));
                    return true;
                }
    ...
    public void resetGame(){
        ...
        playerTurn.setText((playerName[0] + ": I'll Go FIRST AGAIN!"));
    }
    //setter&getter
